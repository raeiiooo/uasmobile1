  ...
  return (
    <SafeAreaView className="bg-primary h-full">
      <ScrollView className="px-4 my-6">
        ...
        <FormField title="Judul Video" value={form.title} placeholder="Berikan judul yang menarik..." handleChangeText={(e) => setForm({ ...form, title: e })} otherStyles="mt-10" />
        ...
        <FormField title="Caption" value={form.prompt} placeholder="Berikan caption yang menarik...." handleChangeText={(e) => setForm({ ...form, prompt: e })} otherStyles="mt-7" />

        <CustomButton title="Upload & Bagikan" handlePress={submit} containerStyles="mt-7" isLoading={uploading} />
      </ScrollView>
    </SafeAreaView>
  );
};
